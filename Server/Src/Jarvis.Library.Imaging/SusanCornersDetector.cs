...
namespace Jarvis.Library.Imaging
{
    public class SusanCornersDetector
    {
        ...
        /// 
        public IReadOnlyCollection<Point> ProcessImage(Stream stream)
        {
            ...
            IReadOnlyCollection<Point> corners;
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        private IReadOnlyCollection<Point> ProcessImage(BitmapData imageData)
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        public IReadOnlyCollection<Point> ProcessImage(UnmanagedImage image)
        {
            // check image format
            if (
                (image.PixelFormat != PixelFormat.Format8bppIndexed) &&
            ...
            var cornersList = new List<Point>();
