...
namespace Jarvis.Library.Imaging
{
    ...
    public static class Drawing
    {
        ...
        public static unsafe void Rectangle(UnmanagedImage image, Rectangle rectangle, Color color)
        {
            ...
            Line(image, new Point(rectX1, rectY1), new Point(rectX2, rectY1), color);
            Line(image, new Point(rectX2, rectY2), new Point(rectX1, rectY2), color);

            Line(image, new Point(rectX2, rectY1 + 1), new Point(rectX2, rectY2 - 1), color);
            Line(image, new Point(rectX1, rectY2 - 1), new Point(rectX1, rectY1 + 1), color);
        }
        ...
        /// </para></remarks>
        /// 
        public static void Polygon(BitmapData imageData, List<Point> points, Color color)
        {
        ...
        /// </para></remarks>
        /// 
        public static void Polygon(UnmanagedImage image, List<Point> points, Color color)
        {
        ...
        /// </para></remarks>
        /// 
        public static void Polyline(BitmapData imageData, List<Point> points, Color color)
        {
        ...
        /// </para></remarks>
        /// 
        public static void Polyline(UnmanagedImage image, List<Point> points, Color color)
        {
            for (int i = 1, n = points.Count; i < n; i++)
            {
                Line(image, points[i - 1], points[i], color);
